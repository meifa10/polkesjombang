...
<body class="bg-slate-100 min-h-screen">
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        ...
        <div class="w-full max-w-lg">
            ...
            {{-- BACK --}}
            <a href="/dashboard"
                class="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-emerald-600 font-bold mb-5 transition-all">
            ...
            <div class="bg-white rounded-[35px] overflow-hidden border border-slate-200 shadow-2xl">
                ...
                <div class="p-8">
                    ...
                    @if($pembayaran->status != 'lunas')
                        ...
                        <button
                            id="pay-button"
                            class="w-full h-16 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-black uppercase tracking-[0.2em] transition-all shadow-xl shadow-emerald-200 active:scale-95">
